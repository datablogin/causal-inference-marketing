...
class IVEstimator(BaseEstimator):
    ...
    def __init__(
        ...
        # Internal state
        self._first_stage_fitted_model: Optional[SklearnBaseEstimator] = None
        self._second_stage_fitted_model: Optional[SklearnBaseEstimator] = None
        self._instrument_data: Optional[InstrumentData] = None
        self._first_stage_predictions: Optional[NDArray[Any]] = None
        self._weak_instrument_test_results: Optional[dict[str, Any]] = None
    ...
    def _fit_implementation(
        ...
        instrument: Optional[InstrumentData] = None,
    ) -> None:
