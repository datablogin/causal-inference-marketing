...
class IPWEstimator(OptimizationMixin, BootstrapMixin, BaseEstimator):
    ...
    def __init__(
        ...
        weight_truncation: Optional[str] = None,
        ...
        self.weights: Optional[NDArray[Any]] = None
        self._propensity_features: Optional[list[str]] = None

        # Diagnostics
        self._overlap_diagnostics: Optional[dict[str, Any]] = None
        self._weight_diagnostics: Optional[dict[str, Any]] = None
    ...
    def _print_optimization_summary(
        ...
        opt_diag: Optional[dict[str, Any]],
    ) -> None:
        ...
        if opt_diag is not None:
            ...
            print(f"Optimized weight variance: {opt_diag['weight_variance']:.4f}")
            print(
    ...
    def _fit_implementation(
        ...
        if self.optimization_config and self.optimization_config.optimize_weights:
            ...
            self._print_optimization_summary(baseline_diag, opt_diag)
        else:
    ...
    def get_weights(self) -> Optional[NDArray[Any]]:
    ...
    def get_overlap_diagnostics(self) -> Optional[dict[str, Any]]:
    ...
    def get_weight_diagnostics(self) -> Optional[dict[str, Any]]:
